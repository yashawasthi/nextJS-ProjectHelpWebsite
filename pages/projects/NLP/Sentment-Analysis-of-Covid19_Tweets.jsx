...
function Buildacustomgooglemapstheme() {
  ...
  return (
    <div>
      <Head>
        <title>
Sentiment analysis of Covid19 tweets</title>
        <meta
          name="description"
        ...
        <div className={`project__details__banner ${isScrolledPass ? 'project__details__banner__onScroll' : ''}`}>
          <div className='container'>
            ...
            <div className='project__heading'>
              <h1>
Sentiment analysis of Covid19 tweets</h1>
              <div>
            ...
            <div className='row'>
              <div className='col-md-8 col-sm-12'>
                ...
                <div className='projects__details__container'>
                  <h4>Introduction</h4>
                  <p>
                  In this project perform the Exploratory data analysis and  implement
                   a twitter sentiment analysis model that helps to overcome the 
                   challenges of identifying the sentiment of the tweets. 
                  ...
                  <p><b>Key highlights of projects or Essence</b>
                    <ul>
                      <li>This project is about Exploratory data analysis and sentiment analysis with classification.</li>

                      <li>This project shows you how to read the data, text data and preprocess it. </li>

                      <li>This project shows you how to use the text data sentiment analysis.  </li>
                      <li>This project shows you how to highlight the popular words based on frequency using word clouds. </li>
                        <li>At the end of the script will show you build the machine learning model to predict the sentiment</li>
                    </ul>
                  </p>
                  ...
                  <ul>
                    ...
                    <li>If you work on a colab no need to install python or Any other IDE, you need to just sign in with google colab.</li>
                  </ul>
                </div>
