...
import mapImg from '../../../public/assets/Whether.png'
...
function Buildacustomgooglemapstheme() {
  ...
  return (
    ...
    <div  style={{ opacity: clicked === true? '0.3': '1'}}>
      <Head>
        <title>Build a Whether App in reactjs</title>
        <meta 
        name="description" 
          ...
          <div className='container'>
              <div className='project__category'>
                ...
                <div className='project__heading'>
                  <h1>Build a Whether App in reactjs</h1>
                  <div>
          ...
          <div className='row'>
              <div className='col-md-8 col-sm-12'>
                  <div className='projects__practice__content'>
                      ...
                      creating and styling a Whether App
                       in reactjs with the help of react hooks and axios
                      </p>
                  </div>
                  <div className='projects__details__container'>
                      <h4>Introduction</h4>
                      <p>
                          In this project we will have a top input field which will be used to take the input for searching any place of users choice and beneath it we'll have a card which will display
                          the whether of that particular place. As the user will input the data we will filter our data and show him the related
                          whether details of that particular place.
                      </p>
                      <Image 
                      src={mapImg}
                      alt="img"
                      ...
                      height={'300px'}
                      />
                      <p>There will be two things used in the project.
                   <ul>
                      <li>UseState Hook</li>
                      <li>Axios</li>
                   </ul>
                      ...
                      <b>UseState Hook</b><br></br>
                      UseState Hoom will be used to detect any change in the input field and change the place name 
                      accordingly.
</p>
                      <p>
                      <b>Axios</b><br></br>
                      Axios will be used to fetch data from the api. Later either we can fetch all the data and filter out our desired place's whether or 
                      can send request and fetch data as user inputs
                      </p>
