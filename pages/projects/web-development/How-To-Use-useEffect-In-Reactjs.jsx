...
import mapImg from '../../../public/assets/UseEffectInReact.png'
          ...
          <div className='container'>
              <div className='project__category'>
                ...
                <div className='project__heading'>
                  <h1>How to use useEffect In ReactJS</h1>
                  <div>
          ...
          <div className='row'>
              <div className='col-md-8 col-sm-12'>
                  <div className='projects__practice__content'>
                      ...
                      <p>
                      We will learn how we can use useEffect in ReactJS.
                      </p>
                  </div>
                  <div className='projects__details__container'>
                      ...
                      <h4 className="mt-3">About useEffect</h4>
                      <ul>
