...
import mapImg from '../../../public/assets/CryptoCurrency.png'
...
function Buildacustomgooglemapstheme() {
  ...
  return (
    <div>
      ...
      <Head>
        <title>Buid CryptoCurrency App using ReactJS</title>
        <meta 
        name="description" 
          ...
          <div className='container'>
              <div className='project__category'>
                ...
                <div className='project__heading'>
                  <h1>Buid CryptoCurrency App using ReactJS</h1>
                  <div>
          ...
          <div className='row'>
              <div className='col-md-8 col-sm-12'>
                  <div className='projects__practice__content'>
                      ...
                      creating and styling a Cryptocurrency App
                       in reactjs with the help of hooks and Axios
                      </p>
                  </div>
                  <div className='projects__details__container'>
                      <h4>Introduction</h4>
                      <p>
                          In this project we will have a top input field which will be used to take the input for searching any CryptoCurrency and beneath it we'll  display
                          the currencies and their details which we have already fetch from API.
                      </p>
                      <Image 
                      src={mapImg}
                      alt="img"
                      ...
                      height={'300px'}
                      />
                      <p>There will be three functionalities in the project.
                   <ul>
                      <li>Search bar</li>
                      <li>Currency Display Area</li>
                   </ul>



                      <b>Search bar</b><br></br>
                      User can search for any currency details by typing its name in the search bar area
</p>
                      <p>
                      <b>Currency Display Area</b><br></br>
                      Inside this area we will display all the details of the currencies fetched by Axios from the API.
                      </p>
