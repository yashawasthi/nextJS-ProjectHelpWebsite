...
import mapImg from '../../../public/assets/HTML-CSS1.png'
...
function Buildacustomgooglemapstheme() {
  ...
  return (
    <div>
      ...
      <Head>
        <title>Navigation Bar Using HTML/CSS</title>
        <meta 
        name="description" 
          ...
          <div className='container'>
              <div className='project__category'>
                ...
                <div className='project__heading'>
                  <h1>Navigation Bar Using HTML/CSS</h1>
                  <div>
          ...
          <div className='row'>
              <div className='col-md-8 col-sm-12'>
                  <div className='projects__practice__content'>
                      ...
                      <p>
                      A navigation bar is a user interface element within 
                      a webpage that contains links to other sections of the website.
                      </p>
                  </div>
