...
import mapImg from '../../../public/assets/HamBurgerMenu.png'
...
function Buildacustomgooglemapstheme() {
  ...
  return (
    <div>
      ...
      <Head>
        <title>Buid Hamburger Using HTML/CSS</title>
        <meta 
        name="description" 
          ...
          <div className='row'>
              <div className='col-md-8 col-sm-12'>
                  <div className='projects__practice__content'>
                      ...
                      <p>
                          We will give open and closing functionality to our Hamburger Menu
                      </p>
                  </div>
                  <div className='projects__details__container'>
                      <h4>Introduction</h4>
                      <p>
                          In this project we will learn how we can use Hamburger Menu using
                          HTML , CSS and Javascript.We will give a icon which will open and close the menu
                      </p>
                      <Image 
                      src={mapImg}
                      alt="img"
                      ...
                      height={'300px'}
                      />
                        <p>On the home page we will see an icon and when we click on it the hamburger menu will appear and then by clicking on the close icon we can again close the menu</p>
