...
import mapImg from '../../../public/assets/HowToSendProps.png'
...
function Buildacustomgooglemapstheme() {
  ...
  return (
    <div>
      ...
      <Head>
        <title>How to Send Props In ReactJS</title>
        <meta 
        name="description" 
          ...
          <div className='container'>
              <div className='project__category'>
                ...
                <div className='project__heading'>
                  <h1>How to Send Props In ReactJS</h1>
                  <div>
          ...
          <div className='row'>
              <div className='col-md-8 col-sm-12'>
                  <div className='projects__practice__content'>
                      ...
                      <p>
                      We will learn how we can send props in ReactJS.
                      </p>
                  </div>
                  <div className='projects__details__container'>
                      <h4>Introduction</h4>
                      <p>
                          Props are used to send data from one functional component to the other.It makes the transfer of data easy and simple.
                      </p>
                      <Image 
                      src={mapImg}
                      alt="img"
                      ...
                      <h4 className="mt-3">About props</h4>
                      <ul>
                        <li>We use props in React to pass data from one component to another (from a parent component to a child component(s)).</li>
                        <li>Props is just a shorter way of saying properties. They are useful when you want the flow of data in your app to be dynamic.</li>
                      </ul>
