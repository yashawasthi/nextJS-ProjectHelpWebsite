...
import mapImg from '../../../public/assets/Routing-In-NodeJS.png'
    ...
    <div>
      {clicked?
        ...
        <div style={{ opacity: clicked === true? '0.3': '1'}}>
          <Head>
        <title>Listening On Port in NodeJS</title>
        <meta 
        name="description" 
          ...
          <div className='row'>
              <div className='col-md-8 col-sm-12'>
                  <div className='projects__practice__content'>
                      ...
                      <p>
                      We will learn how we can do routing in NodeJS.
                      </p>
                  </div>
                  <div className='projects__details__container'>
                      ...
                      <ul>
                        <li>
                        Express.js has an “app” object corresponding to HTTP. We define the routes by using the methods of this “app” object. This app object specifies a callback function, which is called when a request is received. We have different methods in app object for a different type of request.</li>
                        <li>The next() is used to hand off the control to the next callback. Sometimes we use app.use() to specify the middleware function as the callback.</li>
<li>So, to perform routing with the Express.js you have only to load the express and then use the app object to handle the callbacks according to the requirement.</li>
                      </ul>
                  </div>
