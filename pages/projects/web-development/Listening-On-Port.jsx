...
import mapImg from '../../../public/assets/ListeningOnPort.png'
          ...
          <div className='container'>
              <div className='project__category'>
                ...
                <div className='project__heading'>
                  <h1>Listening On Port in NodeJS</h1>
                  <div>
          ...
          <div className='row'>
              <div className='col-md-8 col-sm-12'>
                  <div className='projects__practice__content'>
                      ...
                      <p>
                      We will learn how we can listen on any port we want in NodeJS.
                      </p>
                  </div>
                  <div className='projects__details__container'>
                      ...
                      <ul>
                        <li>
The app. listen() method binds itself with the specified host and port to bind and listen for any connections. </li>
                        <li>If the port is not defined or 0, an arbitrary unused port will be assigned by the operating system that is mainly used for automated tasks like testing, etc.</li>
                      </ul>
                  </div>
