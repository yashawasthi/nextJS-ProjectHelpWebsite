...
import mapImg from '../../../public/assets/ReactDOM.png'
...
function Buildacustomgooglemapstheme() {
  ...
  return (
    <div>
      ...
      <Head>
        <title>How to use useEffect in ReactJS</title>
        <meta 
        name="description" 
          ...
          <div className='container'>
              <div className='project__category'>
                ...
                <div className='project__heading'>
                  <h1>What is ReactDOM In ReactJS</h1>
                  <div>
          ...
          <div className='row'>
              <div className='col-md-8 col-sm-12'>
                  <div className='projects__practice__content'>
                      ...
                      <p>
                      We will learn what is ReactDOM in ReactJS.
                      </p>
                  </div>
                  <div className='projects__details__container'>
                      ...
                      <h4 className="mt-3">About ReactDOM</h4>
                      <ul>
                        <li> ReactDOM is a package that provides DOM specific methods that can be used at the top level of a web app to enable an efficient way of managing DOM elements of the web page.</li>
                      </ul>
