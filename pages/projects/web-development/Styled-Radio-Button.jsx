...
import mapImg from '../../../public/assets/RadioButtons.png'
          ...
          <div className='row'>
              <div className='col-md-8 col-sm-12'>
                  <div className='projects__practice__content'>
                      ...
                      <p>
                          We will use radio buttons and will style them
                      </p>
                  </div>
                  <div className='projects__details__container'>
                      <h4>Introduction</h4>
                      <p>
                          In this project we will learn how we can use Radio Buttons in HTML and style them using
                          CSS.
                      </p>
                      <Image 
                      src={mapImg}
                      ...
                      height={'300px'}
                      />
                        <p>On the home page we will see some dummy text and styled Radio Buttons.We will also give different background color to different sections of the page</p>
