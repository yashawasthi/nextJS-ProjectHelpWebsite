...
import mapImg from '../../../public/assets/DatabaseConnection.png'
          ...
          <div className='row'>
              <div className='col-md-8 col-sm-12'>
                  <div className='projects__practice__content'>
                      ...
                      <p>
                      In this project, you will larn how we can connect database [MongoDB] with NodeJS. 
                      </p>
                  </div>
                  <div className='projects__details__container'>
                      <h4>Introduction</h4>
                      <p>
                          In this project we'll learn how we can connect MongoDB with our Node Application.
                      </p>
                      <Image 
                      src={mapImg}
                      alt="img"
                      ...
                      height={'300px'}
                      />
                      <p>Need of using a database:
                   <ul>
                      <li>Large volumes of data can be stored in one place.  </li>
                      <li>Multiple users can read and modify the data at the same time.</li>
                      <li>Databases are searchable and sortable, so the data you need can be found quick and easily.</li>
                   </ul>
</p>
