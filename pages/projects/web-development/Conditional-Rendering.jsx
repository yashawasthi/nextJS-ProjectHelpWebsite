...
import mapImg from '../../../public/assets/ConditionalRendering.png'
...
function Buildacustomgooglemapstheme() {
  ...
  return (
    <div>
      ...
      <Head>
        <title>Conditional Rendering in Reactjs</title>
        <meta 
        name="description" 
          ...
          <div className='container'>
              <div className='project__category'>
                ...
                <div className='project__heading'>
                  <h1>Conditional Rendering in reactjs</h1>
                  <div>
          ...
          <div className='row'>
              <div className='col-md-8 col-sm-12'>
                  <div className='projects__practice__content'>
                      ...
                      how and where to use conditional rendering in reactjs.
                      </p>
                  </div>
                  <div className='projects__details__container'>
                      <h4>Introduction</h4>
                      <p>
                      In react.js different types of components are made which are
                       rendered according to the need of the website. Many components
                        are rendered conditionally means it depends on the other factors
                         if other factors fulfill the condition then component will render
                          otherwise not. For example if any user is logged in only then he
                           can see logout button otherwise not.
                      </p>
                      <Image 
                      src={mapImg}
                      alt="img"
                      ...
                      height={'300px'}
                      />
                      <p>There are different types of conditional rendering. Few of them are below:-
                   <ul>
                      <li>if-else</li>
