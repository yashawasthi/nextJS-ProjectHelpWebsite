...
import mapImg from '../../../public/assets/TravelLog.png'
...
function Buildacustomgooglemapstheme() {
  ...
  return (
    <div>
      ...
      <Head>
        <title>Build a TravelLog App in reactjs</title>
        <meta 
        name="description" 
          ...
          <div className='container'>
              <div className='project__category'>
                ...
                <div className='project__heading'>
                  <h1>Build a TravelLog App in reactjs</h1>
                  <div>
          ...
          <div className='row'>
              <div className='col-md-8 col-sm-12'>
                  <div className='projects__practice__content'>
                      ...
                      creating and styling a Travel Log App
                  ...
                  <div className='projects__details__container'>
                      <h4>Introduction</h4>
                      <p>
                          In this project we will be able to add the name and details of the places we have recently visited and 
                          can submit them.We will also be able to update and and delete our entries of the places which we have saved.
                      </p>
                      <Image 
                      src={mapImg}
                      alt="img"
                   ...
                   <ul>
                      ...
                      <b>Save Place</b><br></br>
                      We will save the details of the place visited by user in our MongoDB.
</p>
                      <p>
                      <b>Fetch Places</b><br></br>
                      We will fetch the details of the places visited by the user using Axios and will display them on the screen.
                      </p>
                      <p>
                      <b>Update Place</b><br></br>
