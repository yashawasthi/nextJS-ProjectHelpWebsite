...
import mapImg from '../../../public/assets/PeopleTracker.png'
...
function Buildacustomgooglemapstheme() {
  ...
  return (
    <div>
      ...
      <Head>
        <title>Build a People Tracker App in reactjs</title>
        <meta 
        name="description" 
          ...
          <div className='container'>
              <div className='project__category'>
                ...
                <div className='project__heading'>
                  <h1>Build a People Tracker App in reactjs</h1>
                  <div>
          ...
          <div className='row'>
              <div className='col-md-8 col-sm-12'>
                  <div className='projects__practice__content'>
                      ...
                      creating and styling a People Tracker App
                       using NodeJs, ReactJS, MongoDB and Express
                      </p>
                  </div>
                  <div className='projects__details__container'>
                      <h4>Introduction</h4>
                      <p>
                          In this project we will be able to add the name and details and place of the people we have recently met and 
                          can submit them. We will also be able to update and and delete our entries of the people which we have saved.
                      </p>
                      <Image 
                      src={mapImg}
                      alt="img"
                      ...
                      height={'300px'}
                      />
                      <p>There will be these functionalities in the project:
                   <ul>
                      <li>Save Person</li>
                      <li>Fetch People</li>
                      <li>Update Person</li>
                      ...
                      <b>Save Person</b><br></br>
                      We will save the details of the people met by user in our MongoDB.
</p>
                      <p>
                      <b>Fetch People</b><br></br>
                      We will fetch the details of the peopel met by the user using Axios and will display them on the screen in form of cards
                      </p>
                      <p>
                      <b>Update Person</b><br></br>
                      If the user wants to update any entry made by him them we can easily let him him update it and store the new entry in our Database
                      </p>
                      <p>
                      <b>Delete Person</b><br></br>
                      If the user wants to delete any entry then he can easily click on the delete icon which will delete the entry from the database and from the screen as well.
                      </p>
                  ...
                  <div className='projects__info'>
                      <div>
                        ...
                        <div className='d-flex flex-wrap'>
                          ...
                          <div className='grayBadge mx-2'>ExpressJS</div>
