...
import mapImg from '../../../public/assets/HTML-CSS2.png'
          ...
          <div className='row'>
              <div className='col-md-8 col-sm-12'>
                  <div className='projects__practice__content'>
                      ...
                      <p>
                      An HTML Form is a document which stores information of a user on a web server using interactive controls.
                      </p>
                  </div>
                  <div className='projects__details__container'>
                      ...
                      <p>
                      An HTML Form is a document which stores information of a user on a web server using interactive controls.
It is a section of a document containing form elements. Form elements are various types of input elements, such as text fields, checkboxes, radio buttons, submit buttons, labels and so on.
...
The HTML form tag is used for declaring a form. This tag comes in pairs. The special elements which are called controls are written between opening (<form>) and closing (</form>) tags.
                      ...
                      height={'300px'}
                      />
                        <p>Here you can find a collection of various kinds of forms which are created using only HTML and CSS.

The below forms are free to use, you have to copy the code and can paste in any local editor to run it.</p>
