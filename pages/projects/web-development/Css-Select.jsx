...
import mapImg from '../../../public/assets/CssSelect.png'
          ...
          <div className='row'>
              <div className='col-md-8 col-sm-12'>
                  <div className='projects__practice__content'>
                      ...
                      <p>
                          We will style the HTML's select using CSS.We'll also be giving a background color to our project
                      </p>
                  </div>
                  <div className='projects__details__container'>
                      <h4>Introduction</h4>
                      <p>
                          In this project we will learn how we can style HTML's select using CSS.CSS is a very important component when it comes to designing web pages.Using Css make our page and its components look beautiful.
                      </p>
                      <Image 
                      src={mapImg}
                      alt="img"
                      ...
                      height={'300px'}
                      />
                        <p>On the home page we will see a select option with styling and a color background. User can treat this select as a normal select with all the functionalities attached to it</p>
