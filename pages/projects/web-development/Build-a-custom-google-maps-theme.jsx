...
import mapImg from '../../../public/assets/test__image.jpg'
          ...
          <div className='row'>
              <div className='col-md-8 col-sm-12'>
                  ...
                  <div className='projects__details__container'>
                      <h4>Introduction</h4>
                      <p>
                      In this project, you'll be creating and styling a Google Map with a 
                      theme and custom marker images. You'll use Google Cloud Platform to 
                      create the map, and also use the Google Maps JavaScript API to load 
                      the map on a website.
                       I've created a Super Mario themed map here but you are welcome to 
                       use any style you'd like!
                      </p>
                      <Image 
                      src={mapImg}
                      alt="img"
                      ...
                      <ul>
                        <li>Display a Google Map on your website with a custom color theme</li>
                        <li>Center the map at a particular latitude/longitude</li>
                        <li>Use custom markers around the map</li>
                      </ul>
                  </div>
