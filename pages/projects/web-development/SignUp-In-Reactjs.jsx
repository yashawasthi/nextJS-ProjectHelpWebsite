...
import mapImg from '../../../public/assets/SignUp.png'
...
function Buildacustomgooglemapstheme() {
  ...
  return (
    <div>
      ...
      <Head>
        <title>SignUp Design in Reactjs</title>
        <meta 
        name="description" 
          ...
          <div className='container'>
              <div className='project__category'>
                ...
                <div className='project__heading'>
                  <h1>SignUp Design in reactjs</h1>
                  <div>
          ...
          <div className='row'>
              <div className='col-md-8 col-sm-12'>
                  <div className='projects__practice__content'>
                      ...
                      how to create a fully fnctional signup form using reactjs and react hooks.
                      </p>
                  </div>
                  <div className='projects__details__container'>
                      <h4>Introduction</h4>
                      <p>
                      Today, in this project we will learn how to create a signup form in react.js using state and functions.
Functionalities
