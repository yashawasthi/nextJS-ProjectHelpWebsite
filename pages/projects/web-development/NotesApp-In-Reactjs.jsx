...
import mapImg from '../../../public/assets/Notes.png'
...
function Buildacustomgooglemapstheme() {
  ...
  return (
    <div>
      ...
      <Head>
        <title>Build a Notes App in reactjs</title>
        <meta 
        name="description" 
          ...
          <div className='container'>
              <div className='project__category'>
                ...
                <div className='project__heading'>
                  <h1>Build a Notes App in reactjs</h1>
                  <div>
          ...
          <div className='row'>
              <div className='col-md-8 col-sm-12'>
                  <div className='projects__practice__content'>
                      ...
                      creating and styling a Notes App
                  ...
                  <div className='projects__details__container'>
                      <h4>Introduction</h4>
                      <p>
                          In this project we will have a top input field which will be used to take the input for searching any card and beneath it we'll have cards which will display
                          the notes which we have already taken . All previouly saved cards will be displayed in yellow and a single card will be shown in green inside which we'll be able to 
                          add our notes.
                      </p>
                      <Image 
                      src={mapImg}
                      ...
                      height={'300px'}
                      />
                      <p>There will be three buttons in the project.
                   <ul>
                      <li>Toggle button</li>
                      <li>Save button</li>
                      <li>Delete button</li>
                      ...
                      On Clicking Delete button inside the card that particular card will be deleted
</p>
                      <p>
                      <b>Save button</b><br></br>
On clicking save button the content which user have filled in the green card will be saved and a yellow 
card with that data would appear.
                      </p>
                      <p>
                      <b>Toggle button</b><br></br> 
On clicking on the toggle button the background of the page will change
                      </p>
