...
import mapImg from '../../../public/assets/Android2.png'
                        ...
                        <div className='row'>
                            <div className='col-md-8 col-sm-12'>
                                <div className='projects__practice__content'>
                                    ...
                                    <p>
                                    In Android animation I have implemented animation on that animation I 
                                    have set scales of animation scaleX,ScaleY, view animate
                                    </p>
                                </div>
                                <div className='projects__details__container'>
                                    <h4>Introduction</h4>
                                    <p>
                                    Set Duration how much time we can see the animation.

<ul><li>void OnAnimationStart  </li>         

<li>void OnAnimationEnd</li>

<li>void OnanimationCancel</li>

<li>void OnanimationRepeat</li>

<li>In this animation we have to see decreasing when Animation Going To end.

there is countdown is working for 30 sec.</li>
</ul>
